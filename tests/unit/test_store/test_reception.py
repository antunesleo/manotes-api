...
class ClerkCreateAccountTest(base.TestCase):
    ...
    def test_should_raise_invalid_email_if_is_email_returns_false(self, is_email_mock, residents_service_mock, hash_service_mock, token_service_mock, start_send_email_mock):
        ...
        residents_service_mock.create_new_user.return_value = user_mock
    ...
    def test_should_return_user_dict(self, is_email_mock, residents_service_mock, hash_service_mock, token_service_mock, start_send_email_mock):
    ...
    def test_should_start_send_email_after_user_creation(self, is_email_mock, residents_service_mock, hash_service_mock, token_service_mock, start_send_email_mock):
        token_service_mock.generate.return_value = 'qwertyasdfgzxcvb'
        hash_service_mock.hash.return_value = 'qwr324!&8@@333'
        start_send_email_mock.start_send_email.return_value = 10
        user_mock = self.mock.MagicMock()
